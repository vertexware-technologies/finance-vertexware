<svg {{ $attributes->merge(['class' => 'h-7 w-7']) }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
    fill="none" > <rect x="4" y="3" width="16" height="18" rx="2" fill="#7E869E" fill-opacity="0.25" />
    <path
        d="M8.5 6.5L15.5 6.5" stroke="#222222" stroke-linecap="round" />
    <path d="M8.5 9.5L12.5 9.5"
        stroke="#222222" stroke-linecap="round" />
    <path d="M8.5 12.5L14.5 12.5" stroke="#222222"
