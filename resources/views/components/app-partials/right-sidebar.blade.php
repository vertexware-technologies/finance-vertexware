        ...
        <div x-data="{ activeTab: 'tabHome' }"
            ...
            <div x-show="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <label class="relative flex px-3">
                    <input
                        class="peer form-input h-8 w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 text-xs+ ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                    ...
                    <div class="swiper mt-3 px-3" x-init="$nextTick(() => new Swiper($el, { slidesPerView: 'auto', spaceBetween: 16 }))">
                        <div class="swiper-wrapper">
                            <div
                                ...
                                <div
                                    class="mask is-reuleaux-triangle absolute right-0 top-0 -m-3 h-16 w-16 bg-white/20">
                                </div>
                            </div>
                            <div
                ...
                <div class="mt-4 px-3">
                    ...
                    <div class="mt-3 flex space-x-3">
                        ...
                        <a href="{{ route('home/index') }}" class="w-12 text-center">
                            <div class="avatar h-10 w-10">
